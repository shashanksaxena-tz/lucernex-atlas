...
![The platform registry. 207 rows, edit only — no add, no delete. The firm does not own this list.](../assets/screenshots/bbw-admin/27-manage-firm-drop-downs.jpg)
...
![A drop-down value's edit form. Every value carries a required Portfolio/Capital Program scoping chip control.](../assets/screenshots/drop-downs/firm-drop-downs-value-edit-portfolio-scope.png)
