...
![An Edit Layout — fields placed on a canvas, with the Available Fields palette on the left.](../../docs/assets/screenshots/page-layouts/page-layouts-contract-payments-edit-layout.png)
`docs/assets/screenshots/page-layouts/page-layouts-contract-payments-edit-layout.png`

![The List Layout on the *same* PageLayoutID — separate coordinates, separate conditional configuration.](../../docs/assets/screenshots/page-layouts/page-layouts-contract-payments-list-layout.png)
...
![The Available Fields palette, with its link into Custom Lists.](../../docs/assets/screenshots/page-layouts/page-layouts-available-fields-custom-lists-link.png)
...
![Conditional field associations, shown on a placement.](../../docs/assets/screenshots/page-layouts/page-layouts-conditional-field-associations.png)
