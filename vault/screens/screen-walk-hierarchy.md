...
![The containment hierarchy, walked. ~70 child tables under one Contract — this is the shape "a contract is a small header plus twenty-five collections" takes in the schema.](../assets/screenshots/data-model/walk-hierarchy-re-contract-schema.jpg)
`docs/assets/screenshots/data-model/walk-hierarchy-re-contract-schema.jpg`

![The admin entry point, labelled experimental.](../assets/screenshots/bbw-admin/46-view-data-model-data-values-experimental.jpg)
