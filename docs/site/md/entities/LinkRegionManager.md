...
| Physical tables | `link_region_manager` |
...
|---|---|---|---|---|---|---|---|
| `ProjectEntityID` |  |  | Entity ID | — |  | `link_region_manager.ProjectEntityID · TEXT` | [ProjectEntity](ProjectEntity.md) |
