...
*1 fields · module: Documents, Folders & Correspondence · Postgres: `document_markup`*
...
| Physical tables | `document_markup` |
...
|---|---|---|---|---|---|---|---|
| `ProjectEntityID` |  |  | Entity ID | — |  | `document_markup.ProjectEntityID · TEXT` | [ProjectEntity](ProjectEntity.md) |
