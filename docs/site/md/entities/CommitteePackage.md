...
| Physical tables | `committee_package` |
...
|---|---|---|---|---|---|---|---|
| `ProjectEntityID` |  |  | Entity ID | — |  | `committee_package.ProjectEntityID · TEXT` | [ProjectEntity](ProjectEntity.md) |
