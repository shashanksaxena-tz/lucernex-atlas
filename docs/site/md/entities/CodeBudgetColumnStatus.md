...
*3 fields · module: Budgeting, Cost Tracking & Bidding — OUT OF SCOPE · Postgres: `code_budget_column_status`*

Master reference record for budget-column status values, including a locked flag.
...
| Physical tables | `code_budget_column_status` |
...
### Lands in code_budget_column_status
...
|---|---|---|---|---|---|---|---|
| `Inactive` |  |  | Boolean | — |  | `code_budget_column_status.Inactive · TEXT` |  |
...
| Field | Label | What it is for | Declared type | Scope | Req | Physical column | Points at |
|---|---|---|---|---|---|---|---|
| `ActualLongName` | Description |  | Text | — |  | `code_budget_column_status.ActualLongName · TEXT` |  |
| `ShortName` | Name |  | Text | — |  | `code_budget_column_status.ShortName · TEXT` |  |
