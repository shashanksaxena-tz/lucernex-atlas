...
| Physical tables | `folder_security` |
...
|---|---|---|---|---|---|---|---|
| `CodeFolderSecurityTypeID` | Security Setting |  | Dropdown (Security Type Code) | — |  | `folder_security.CodeFolderSecurityTypeID · TEXT` | Security Type Code |
| `CodeUserClassID` | User Class |  | Dropdown (User Class) | — | yes | `folder_security.CodeUserClassID · TEXT` | User Class |
...
| Field | Label | What it is for | Declared type | Scope | Req | Physical column | Points at |
|---|---|---|---|---|---|---|---|
| `FolderID` | Folder |  | Text | — |  | `folder_security.FolderID · TEXT` |  |
