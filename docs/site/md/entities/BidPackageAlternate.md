...
*5 fields · module: Budgeting, Cost Tracking & Bidding — OUT OF SCOPE · Postgres: `bid_package_alternate`*

An alternate (optional add/deduct) bid line offered within a BidPackage, with an accepted flag.
