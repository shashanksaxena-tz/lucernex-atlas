...
| Field | Label | Declared type | Scope | Req | Points at |
|---|---|---|---|---|---|
| `ComparisonItemID` | Comparison Item RecID | Number | Global |  |  |
...
| Field | Label | Declared type | Scope | Req | Points at |
|---|---|---|---|---|---|
| `ScenarioDate` | Scenario Date | Date | Global |  |  |
...
| Field | Label | Declared type | Scope | Req | Points at |
|---|---|---|---|---|---|
| `Assumptions` |  | Text | Global |  |  |
| `ComputedValue` | Computed Value | Text | Global |  |  |
| `ExpenseGroup` | Expense Group Total | Text | Global |  |  |
| `ScenarioName` | Scenario Name | Text | Global |  |  |
| `XmlData` | Scenario XmlData | Text | Global | yes |  |
...
| Field | Label | Declared type | Scope | Req | Points at |
|---|---|---|---|---|---|
| `BOMapClientRecordID` | Comparison Item ClientID | Text | Global | yes |  |
