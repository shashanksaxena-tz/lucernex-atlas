...
*3 fields · module: Variable Rent (Percentage / Use-Based) & Sales · Postgres: `code_sales_group`*

A single-field master value letting one sales group alias to another for reporting rollups.
