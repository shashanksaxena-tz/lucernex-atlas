...
| Physical tables | `link_budget_view_b_l_i` |
...
### Lands in link_budget_view_b_l_i
...
|---|---|---|---|---|---|---|---|
| `ProjectEntityID` |  |  | Entity ID | — |  | `link_budget_view_b_l_i.ProjectEntityID · TEXT` | [ProjectEntity](ProjectEntity.md) |
