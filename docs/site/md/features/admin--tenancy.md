...
Written up in features/administration/README.md, features/data-fields/README.md, features/drop-downs-code-tables/README.md, features/custom-lists/README.md, features/reference-data/README.md. 119 screen captures on disk, under docs/assets/screenshots/bbw-admin, docs/assets/screenshots/af-admin, docs/assets/screenshots/dashboard, docs/assets/screenshots/navigation — the screens themselves, not a description of them. 114 of them are cited by name in the documentation, which is what ties a capture to the screen it shows. Admin tools documented here, each with the capture named after it: Client Drop Downs, Manage CPI Data, Manage Custom Lists, Manage Data Fields, Manage Discount Rates, Manage Exchange Rates, Manage Firm Dictionary, Manage Firm Drop Downs and 3 more. 1 are held back from being shown here: they contain a named individual, and whether those images get redacted is an open decision. They still count as evidence — the file is on disk and named in the docs — they are simply not thumbnailed.
...
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/10-manage-data-fields.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/11-manage-dashboard-reports.jpg)
...
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/16-manage-top-menu.jpg)
...
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/18-manage-bid-package-templates.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/19-manage-budget-templates.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/20-manage-budget-views.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/21-manage-budget-types.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/22-manage-budget-summary-page.jpg)
![2. Administration tools (57)](../../assets/screenshots/bbw-admin/23-manage-budget-index-variables.jpg)
